...
public class CustomerController {
    ...
    @GetMapping("/list")
    public ModelAndView listCustomers(@RequestParam("word") Optional<String> word,@RequestParam(name = "page", required = false, defaultValue = "0") Integer page,
...
//      @PageableDefault(size = 10) Pageable pageable
        ...
        if(word.isPresent()){
            customers = customerService.findAllByFirstNameContaining(word.get(), pageable);
    ...
    @PostMapping("/delete")
    public ModelAndView deleteCustomer(@ModelAttribute("customer") Customer customer, RedirectAttributes redirect){
